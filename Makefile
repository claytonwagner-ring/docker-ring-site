...
# Project variables
PROJECT_NAME ?= docker-ring-site
ORG_NAME ?= dockerproductionaws
REPO_NAME ?= docker-ring-site
TEST_REPO_NAME ?= docker-ring-site-dev
TEST_DIR ?= build/test-results/junit/

# AWS ECR settings
DOCKER_REGISTRY ?= 675276511069.dkr.ecr.us-east-2.amazonaws.com
AWS_ACCOUNT_ID ?= 675276511069
